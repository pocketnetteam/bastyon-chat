        ...
        379: (t) => {
          ...
          function i(t, i) {
            for (var o = {}, a = [], c = 0; c < t.length; c++) {
              ...
              if (-1 !== f) e[f].references++, e[f].updater(v);
              else {
                var p = r(v, i);
                (i.byIndex = c),
                  e.splice(c, 0, { identifier: u, updater: p, references: 1 });
              }
              a.push(u);
            }
            return a;
    ...
    return (
      (() => {
        ...
        function y() {
          ...
          var g = (v.prototype = u.prototype = Object.create(p));
          function w(t) {
          ...
          function x(t, e) {
            function i(r, o, a, c) {
              ...
              if ("throw" !== l.type) {
                var d = l.arg,
                  u = d.value;
                return u && "object" == b(u) && n.call(u, "__await")
          ...
          return (
            ...
            c(g, "constructor", v),
            c(v, "constructor", f),
            (f.displayName = c(v, a, "GeneratorFunction")),
        ...
        var T = (function (t) {
          ...
          function a(t, e, n, i) {
            ...
            return (
              ...
              j(E((r = o.call(this))), "controls", null),
              j(E(r), "isFrontalCamera", !1),
              j(E(r), "videoStreams", null),
              j(E(r), "isMuted", !1),
              j(E(r), "activeCall", null),
              j(E(r), "secondCall", null),
              j(E(r), "syncInterval", null),
              j(E(r), "isWaitingForConnect", !1),
              j(E(r), "signal", null),
              j(E(r), "timer", null),
              j(E(r), "timeInterval", null),
              j(E(r), "title", null),
              j(E(r), "templates", {
                incomingCall: function () {
                  return '\n\t\t\t<div class="bc-incoming-call">\n\t\t\t\t<div class="user">\n\t\t\t\t\t<div class="avatar">\n\t\t\t\t\t\t'
                    ...
                    .concat(
                      this.activeCall.initiator.source.name,
                      '</div>\n\t\t\t\t\t\t<div class="description">'
                    )
                    .concat(
                      this.options.getWithLocale("incomingCall"),
                ...
                endedCall: function (t) {
                  return '\t\n\t\t\t<div class="bc-ended-call">\n\t\t\t\t<div class="avatar">\n\t\t\t\t\t\t'
                    ...
                    .concat(
                      this.options.getWithLocale("endedCall"),
                      "</div>\n\t\t\t</div>"
                    );
                },
                videoCall: function () {
              ...
              j(E(r), "renderTemplates", {
                videoCall: function () {
                  var t;
                  r.root.classList.add("middle"),
                    (r.root.innerHTML =
                      (null === (t = r.templates.videoCall) || void 0 === t
                        ? void 0
                        : t.call(E(r))) || ""),
                    r.initCallInterface("videoCall");
                },
                incomingCall: function (t) {
                  var e;
                  (r.notify.innerHTML =
                    (null === (e = r.templates.incomingCall) || void 0 === e
                      ? void 0
                      : e.call(E(r))) || ""),
                    r.initCallInterface("incomingCall", t);
                },
                ...
                clearInterface: function () {
                  r.root.classList.remove("active"),
                    r.root.classList.remove("minified"),
                    r.root.classList.remove("middle"),
                    r.root.classList.remove("full");
                },
                endedCall: function (t) {
                  var e;
                  r.root.classList.contains("minified") &&
                    (r.root.classList.remove("minified"),
                    r.root.classList.add("middle")),
                    (r.root.innerHTML =
                      (null === (e = r.templates.endedCall) || void 0 === e
                        ? void 0
                        : e.call(E(r), t)) || "");
                },
              }),
            ...
            (n = [
              {
                ...
                value: function (t) {
                  ...
                  t.insertAdjacentHTML(
                    "beforeend",
                    '<div class="bc-container"><div id="bc-notify" class="bc-notify"></div><div id="bc-root"></div></div>'
                  ),
                    (this.root = document.getElementById("bc-root")),
                    (this.notify = document.getElementById("bc-notify")),
                    window &&
                      (window.onunload = function () {
                        e.activeCall && e.activeCall.hangup();
                      });
                },
              },
              {
                                ...
                                case 0:
                                  console.log("incoming call"),
                                    ...
                                    (document.querySelector("title").innerHTML =
                                      t.options.getWithLocale("incomingCall")),
                                    t.emit("initcall"),
                                    (i =
                                      t.client.store.rooms[n.roomId]
                                        .currentState.members),
                                    (r = Object.keys(i).filter(function (e) {
                                      return e !== t.client.credentials.userId;
                                    })),
                                    (o = i[r]),
                                    (a = i[t.client.credentials.userId]),
                                    (n.initiator = o),
                                    (n.user = a),
                                    t.options
                                      .getUserInfo(o.userId)
                                      .then(function (e) {
                                        if (!n.hangupParty && !n.hangupReason) {
                                          (o.source = e[0] || e),
                                            t.addCallListeners(n),
                                            t.activeCall
                                              ? t.secondCall
                                                ? (n.hangup("busy"),
                                                  n.reject("busy"))
                                                : (t.secondCall = n)
                                              : (t.activeCall = n);
                                          var i = new Audio("js/lib");
                                          (i.autoplay = !0),
                                            (i.loop = !0),
                                            (t.signal = i),
                                            t.renderTemplates.incomingCall(n),
                                            (t.signal.src =
                                              "sounds/incoming.mp3");
                                        }
                                      });
              ...
              },
              {
                ...
                value: function () {
                  ...
                  try {
                    console.log(),
                      "connected" !== this.activeCall.state ||
                      "ended" !== this.activeCall.state
                        ? (this.activeCall.answer(),
                          console.log("Ответ на", this.activeCall),
                          this.signal.pause(),
                          this.renderTemplates.clearNotify(),
                          this.renderTemplates.videoCall())
                        : ((this.isWaitingForConnect = !0),
                          this.renderTemplates.clearNotify(),
                          this.activeCall.hangup(),
                          setTimeout(function () {
                            try {
                              console.log("Сброс + ответ на", t.activeCall),
                                t.activeCall.answer(),
                                t.signal.pause(),
                                (t.isWaitingForConnect = !1),
                                t.renderTemplates.videoCall();
                            } catch (e) {
                              console.error(
                                "Ошибка при ответе на вторую линию",
                                e
                              ),
                                t.signal.pause();
                            }
                    ...
                    console.error("error answer", t), this.signal.pause();
                  }
                },
              },
              {
                key: "initsync",
                value: function () {
                  var t = document.querySelector(".bc-video-container");
                  this.activeCall.peerConn.getStats(null).then(function (t) {
                    var e;
                    ((e = t),
                    (function (t) {
                      ...
                      .filter(function (t) {
                        return "candidate-pair" === t[1].type;
                      })
                      .forEach(function (t) {});
                  }),
                      ...
                      function () {
                        ...
                        if (
                          ...
                          var n,
                            i =
                              null == this ||
                              null === (n = this.activeCall) ||
                              void 0 === n
                                ? void 0
                                : n.remoteStream.getVideoTracks()[0];
                          if (this.root.classList.contains("minified")) {
                            var r = i.getSettings().aspectRatio;
                            r &&
              ...
              },
              {
                ...
                value: function (t) {
                  t.stopPropagation();
                  var e = this.activeCall.peerConn
                      .getSenders()
                      .find(function (t) {
                        return "audio" === t.track.kind;
                      }),
                    n = document.querySelector(".bc-mute");
                  e.track.enabled
                    ? (n.firstChild.classList.remove("fa-microphone"),
                      n.classList.add("active"),
                      n.firstChild.classList.add("fa-microphone-slash"))
                    : (n.firstChild.classList.remove("fa-microphone-slash"),
                      n.classList.remove("active"),
                      n.firstChild.classList.add("fa-microphone")),
                ...
                value: function (t) {
                  ...
                  var e = this.activeCall.peerConn
                      ...
                      .find(function (t) {
                        ...
                        return (
                          "video" ===
                            (null === (e = t.track) || void 0 === e
                              ? void 0
                              : e.kind) || !t.track
                        );
                      }),
                    n = document.querySelector(".bc-hide");
                  e.track.enabled
                    ? (n.firstChild.classList.remove("fa-video"),
                      n.classList.add("active"),
                      n.firstChild.classList.add("fa-video-slash"))
                    : (n.firstChild.classList.remove("fa-video-slash"),
                      n.classList.remove("active"),
                      n.firstChild.classList.add("fa-video")),
                    (e.track.enabled = !e.track.enabled);
                },
              },
              {
                ...
                value: function () {
                  navigator.mediaDevices.enumerateDevices().then(function (t) {
                    ...
                    e.length <= 1 &&
                      ((document.getElementById("bc-camera").style.display =
                        "none"),
                      console.log("no cameras", e));
                  });
                },
              },
              {
                    ...
                    navigator.mediaDevices
                      ...
                      .then(function (t) {
                        var i,
                          ...
                          a = n.activeCall.peerConn
                            .getSenders()
                            .find(function (t) {
                              return "video" === t.track.kind;
                            });
                        if (
                          (a &&
                            null != a &&
                            ...
                            i.includes("front") &&
                            (n.isFrontalCamera = !0),
                          console.log("video list", o),
                          o.length > 1)
                        ) {
                          a.track.label.includes("front") ||
                          a.track.label.includes("передней")
                            ? (console.log("to back"),
                              (r = o.reverse().find(function (t) {
                                return (
                                  t.label.includes("back") ||
                                  t.label.includes("задней")
                                );
                              })))
                            : (console.log("to front"),
                              (r = o.find(function (t) {
                                return (
                                  t.label.includes("front") ||
                                  t.label.includes("передней")
                                );
                              })));
                          var c = {};
                          c.deviceId = { exact: r.deviceId };
                          var l = { video: c, audio: !1 };
                          navigator.mediaDevices
                            .getUserMedia(l)
                            .then(function (t) {
                              t.getTracks().forEach(function (e) {
                                var i = n.activeCall.peerConn
                                  .getSenders()
                                  .find(function (t) {
                                    return t.track.kind == e.kind;
                                  });
                                i.track.label !== e.label
                                  ? (e.muted,
                                    i.replaceTrack(e),
                                    (n.videoStreams.local.srcObject = t))
                                  : console.log("same streams on change");
                              }),
                                e.hide();
                            })
                            .catch(function (t) {
                              console.log("Const stream: " + t.message);
                            });
                        }
                      })
                      .catch(function (t) {});
              ...
              },
              {
                key: "format",
                value: function () {
                  this.root.classList.contains("middle")
                    ? (this.root.classList.remove("middle"),
                      this.root.classList.add("full"))
                    : this.root.classList.contains("full") &&
              ...
              },
              {
                ...
                value: function (t) {
                  ...
                  this.emit("initcall");
                  var i = matrixcs.createNewMatrixCall(this.client, t);
                  if (
                    (i
                      .placeVideoCall(
                                ...
                                for (;;)
                                  switch ((t.prev = t.next)) {
                                    case 0:
                                      return (
                                        (e =
                                          this.client.store.rooms[i.roomId]
                                            .currentState.members),
                                        (n = Object.keys(e).filter(function (
                                          t
                                        ) {
                                          return (
                                            t !== a.client.credentials.userId
                                          );
                                        })),
                                        (r = e[n]),
                                        (o = e[this.client.credentials.userId]),
                                        (i.initiator = r),
                                        (i.user = o),
                                        (t.next = 8),
                                        this.options.getUserInfo(r.userId)[0]
                                      );
                                    case 8:
                                      (r.source = t.sent),
                                        this.options
                                          .getUserInfo(r.userId)
                                          .then(function (t) {
                                            (r.source = t[0] || t),
                                              (a.signal.src =
                                                "sounds/calling.mp3"),
                                              a.renderTemplates.videoCall();
                                          })
                                          .catch(function (t) {
                                            return console.log(
                                              "get user info error",
                    ...
                    this.addCallListeners(i),
                    !this.activeCall)
                  ) {
                    this.activeCall = i;
                    var r = new Audio("js/lib");
                    return (
                      (r.autoplay = !0), (r.loop = !0), (this.signal = r), i
                    );
                  }
                },
              },
              {
                key: "hexDecode",
                value: function (t) {
                  for (var e = 0, n = "", i = 2; i <= t.length; i += 2)
                    (e = parseInt(t.substring(i - 2, i), 16)) >= 128 &&
                      (e += 848),
                      (n += e = String.fromCharCode("0x" + e.toString(16)));
                  return n;
                },
              },
              {
                ...
                value: function (t) {
                  t.stopPropagation(),
                    this.activeCall.hangup("ended", !1),
              ...
              },
              {
                key: "reject",
                value: function (t) {
                  t.reject("busy"), this.signal.pause();
                },
              },
              {
                ...
                value: function (t, e) {
                  ...
                  switch (t) {
                    ...
                    case "videoCall":
                      ...
                      try {
                        this.activeCall.setLocalVideoElement(
                          this.videoStreams.local
                        ),
                          this.activeCall.setRemoteVideoElement(
                            this.videoStreams.remote
                          ),
                          this.cameraCount(),
              ...
              {
                key: "addVideoInterfaceListeners",
                value: function () {
                  var t = this;
                  document
                    .getElementById("remote-scene")
                    .addEventListener("click", function (e) {
                      return t.pip.call(t, e);
                    }),
                    document
                      .getElementById("bc-decline")
                      .addEventListener("click", function (e) {
                        return t.hangup.call(t, e);
                      }),
                    document
                      .getElementById("bc-mute")
                      .addEventListener("click", function (e) {
                        return t.mute.call(t, e);
                      }),
                    document
                      .getElementById("bc-hide")
                      .addEventListener("click", function (e) {
                        return t.hide.call(t, e);
                      }),
                    document
                      .getElementById("bc-camera")
                      .addEventListener("click", function (e) {
                        return t.camera.call(t, e);
                      }),
                    document
                    ...
                    document
                      .getElementById("bc-cog")
                      .addEventListener("click", function (e) {
                        return t.settings.call(t, e);
                      }),
                    document
              ...
              {
                key: "addCallListeners",
                value: function (t) {
                  var e = this;
                  t.on("state", function (n, i) {
                    console.log("state", n, t),
                      "connected" === n &&
                        (e.showRemoteVideo(),
                        e.timeInterval || e.initTimer(),
                        e.signal.pause(),
                        (document.querySelector("title").innerHTML = e.title),
                        e.initsync()),
                      "ended" === n &&
                        (e.clearTimer(),
                        clearInterval(e.syncInterval),
                        (e.syncInterval = null),
                        e.signal.pause(),
                        (document.querySelector("title").innerHTML = e.title));
                  }),
                    t.on("hangup", function (t) {
                      var n, i;
                      if (
                        (console.log("hangup", t),
                        clearInterval(e.syncInterval),
                        (e.syncInterval = null),
                        t || e.renderTemplates.clearNotify(),
                        t.callId ===
                          (null === (n = e.secondCall) || void 0 === n
                            ? void 0
                            : n.callId) &&
                          ((e.secondCall = null),
                          e.renderTemplates.clearNotify()),
                        t.callId ===
                          (null === (i = e.activeCall) || void 0 === i
                            ? void 0
                            : i.callId))
                      ) {
                        if (e.isWaitingForConnect)
                          return (
                            (e.activeCall = e.secondCall),
                            void (e.secondCall = null)
                          );
                        if (
                          (e.renderTemplates.clearVideo(),
                          e.renderTemplates.clearNotify(),
                          "local" === t.hangupParty || t.localVideoElement)
                        )
                          return e.root.classList.contains("minified") ||
                            !e.root.classList.length
                            ? (e.renderTemplates.clearVideo(),
                              e.renderTemplates.clearInterface(),
                              void (e.activeCall = null))
                            : (e.renderTemplates.endedCall(t),
                              "user_hangup" !== t.hangupReason ||
                                t.remoteStream ||
                                "local" === t.hangupParty ||
                                ((e.signal.loop = !1),
                                (e.signal.src = "sounds/busy.mp3")),
                              void setTimeout(function () {
                                e.renderTemplates.clearVideo(),
                                  e.renderTemplates.clearInterface(),
                                  (e.activeCall = null);
                              }, 3e3));
                        e.signal.pause(), e.renderTemplates.clearInterface();
                      }
                    }),
                    t.on("replaced", function (t) {
                      console.log("replaced", t),
                        console.log("old", e.activeCall),
                        (e.activeCall = null),
                        e.signal.pause();
                      var n =
                          e.client.store.rooms[t.roomId].currentState.members,
                        i =
                          n[
                            Object.keys(n).filter(function (t) {
                              return t !== e.client.credentials.userId;
                            })
                          ],
                        r = n[e.client.credentials.userId];
                      (t.initiator = i),
                        (t.user = r),
                        e.options.getUserInfo(i.userId).then(function (n) {
                          t.hangupParty ||
                            t.hangupReason ||
                            ((i.source = n[0] || n),
                            e.addCallListeners(t),
                            console.log("listen added", e, t),
                            e.activeCall
                              ? e.secondCall
                                ? (console.log("all lines"),
                                  ...
                                  t.reject("busy"))
                                : ((e.secondCall = t),
                                  console.log("now second", e.secondCall))
                              : ((e.activeCall = t),
                                console.log("now active", e.activeCall)),
                            "wait_local_media" === t.state
                              ...
                              : (e.answer(), e.showRemoteVideo()));
                        });
                    }),
                    t.on("error", function (n) {
                      console.error("some error", n, e),
                        t.hangup("error"),
                        e.signal.pause(),
                        e.renderTemplates.clearVideo(),
                        e.emit("error", n);
              ...
              },
              {
                ...
                value: function () {
                  var t, e;
                  return null !== (t = this.activeCall.initiator) &&
                    void 0 !== t &&
                    null !== (e = t.source) &&
                    void 0 !== e &&
                    e.image
                    ...
                    : this.activeCall.initiator.source.name[0].toUpperCase();
                },
              },
              {
                key: "showRemoteVideo",
                value: function () {
                  document
                    .getElementById("remote-scene")
                    .classList.remove("novid");
                },
              },
              {
                key: "initCordovaPermisions",
                value: function () {
                  var t;
                  if (null !== (t = window) && void 0 !== t && t.cordova) {
                    var e = cordova.plugins.permissions,
                      n = [e.CAMERA, e.RECORD_AUDIO];
