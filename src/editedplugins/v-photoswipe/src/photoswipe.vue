    ...
    <div class="pswp__scroll-wrap">
      ...
      <div class="pswp__ui pswp__ui--hidden">
        <div class="pswp__top-bar">
          ...
          <button class="pswp__button pswp__button--close" title="关闭 (Esc)" />
          <button class="pswp__button pswp__button--share" title="分享" />
          <button
            :class="'pswp__button pswp__button--download ' + shareclass"
            @click="downloadImage()"
          />
          <button class="pswp__button pswp__button--fs" title="全屏切换" />
