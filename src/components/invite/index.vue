<template>
  ...
  <div id="invite" v-else :class="{'bin' : pocketnet, 'bout' : !pocketnet, minimized, fix : pocketnet, active}">
    <div class="work">
      ...
      <!-- <div v-else> -->
        ...
        <div v-id="currentType == 'sms' || currentType == 'email'">
          ...
          <!-- Contacts list -->
          <listPhoneContacts @invitePhoneContact="invitePhoneContact" :phoneContacts="displayedPhoneContacts" :type="currentType"/>
        </div>
        ...
        <!-- No results message -->
        <div class="noSearchResult" v-if="inputText.length >= 3 && !displayedPhoneContacts.length && !loading">
