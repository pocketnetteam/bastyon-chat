				...
				<div class="wrapper">
					<div v-if="!loading">
						<div v-if="unauthorized == 'unauthorized'">
							...
							<div class="label">User unauthorized</div>
						</div>
						...
						<div v-if="unauthorized == 'deleted'">
							...
							<div class="label">User deleted</div>
						</div>
						...
						<div v-if="unauthorized == 'unknown'">
							...
							<div class="connect" v-if="connect && usersinfo[connect]">
								...
								<preview :contact="usersinfo[connect]" mode="mini" />
							</div>

							<div class="connect joinroom" v-if="joinroom && !connect">
								<div class="connectCaption">
									<span>
										When registration is complete, you will be redirect to
										public room
									</span>
								</div>
							</div>
